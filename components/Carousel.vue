                ...
                <div class="col-lg-6 mb-lg-auto">
                    <div class="rounded shadow-lg overflow-hidden transform-perspective-right">
                        <b-carousel id="carousel1"
                            ...
                            <b-carousel-slide :img-src="HOME_PATH+'img/theme/img-1-1200x1000.jpg'"></b-carousel-slide>
                            <b-carousel-slide :img-src="HOME_PATH+'img/theme/img-2-1200x1000.jpg'"></b-carousel-slide>
                        </b-carousel>
                    </div>
                </div>
            </div>
...
<script>
import { BCarousel } from "~npm/bootstrap-vue/esm/components/carousel/carousel";
import { BCarouselSlide } from "~npm/bootstrap-vue/esm/components/carousel/carousel-slide";
